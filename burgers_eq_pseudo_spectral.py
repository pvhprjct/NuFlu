...
def timestep(u_hat,u0_hat):   # u acts as u^{n+1} whereas u0 acts as u^{n}
    for i in range(0,int(t_max)):
        u1 = np.fft.irfft(u0_hat)       # Transform back into physical space to compute the quadratic term.
